...
// Version1 版本号占用0字节的左半部分, 目前只有0b0001
const Version1 VersionBits = 1 << 4

// HeaderSize4 协议头大小(4字节为单位), 占用0字节的右半部分, 目前只有4字节
const HeaderSize4 HeaderSizeBits = 1
...
// Unmarshal 反序列化二进制数据到Message并返回BinaryProtocol
